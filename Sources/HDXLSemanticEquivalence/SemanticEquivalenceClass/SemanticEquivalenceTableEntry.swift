...
extension SemanticEquivalenceTableEntry {
  ...
  internal var isValid: Bool {
    guard
      ...
      allEquivalenceClassesHaveCommonIdentifier
    else {
      return false
    }
    return true
  ...
  @inlinable
  internal var allEquivalenceClassesHaveCommonIdentifier: Bool {
    equivalenceClasses.allSatisfy { (equivalenceClass) in
      equivalenceClass.semanticEquivalenceClassIdentifier == semanticEquivalenceClassIdentifier
    }
  }
