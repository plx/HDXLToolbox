...
extension AlgebraicProduct9 {
  ...
  @inlinable
  public func with(i: I) -> Self {
    mutation(of: self) { $0.i = i }
  }
...
extension AlgebraicProduct9 where A: Equatable {
...
extension AlgebraicProduct9 where B: Equatable {
...
extension AlgebraicProduct9 where C: Equatable {
...
extension AlgebraicProduct9 where D: Equatable {
...
extension AlgebraicProduct9 where E: Equatable {
...
extension AlgebraicProduct9 where F: Equatable {
...
extension AlgebraicProduct9 where G: Equatable {
...
extension AlgebraicProduct9 where H: Equatable {
...
extension AlgebraicProduct9 where I: Equatable {
  
  @inlinable
  public func with(i: I) -> Self {
    guard i != self.i else { return self }
    
    return mutation(of: self) { $0.i = i }
  }
